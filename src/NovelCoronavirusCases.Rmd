...
ScrapeTSStatsType <- function(targetUrl) {
    ts_type <- NULL
...
ScrapeTSStats.Global <- function(...) {
   ...
   ts_type <- ScrapeTSStatsType(targetUrl)
...
Cluster.ExportNamespace(cr, list('ScrapeStats', 'ScrapeStats.USA', 'ScrapeStats.Global', 'ScrapeTSStats', 'ScrapeTSStats.USA', 'ScrapeTSStats.Global', 'ScrapeTSStatsType', 'tbl_href'))
```
